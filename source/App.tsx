      ...
      <header className="backdrop-blur-2xl bg-black/30 border-b border-white/5 sticky top-0 z-40 shadow-[0_8px_32px_rgba(0,0,0,0.4)]">
        <div className="max-w-lg mx-auto px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            <button onClick={() => setShowMenu(!showMenu)} className="w-10 h-10 rounded-xl flex items-center justify-center text-xl bg-white/5 border border-white/10 hover:bg-[#D4AF37]/20 transition-all">☰</button>
            <img src={LG} alt="D" className="w-10 h-10 drop-shadow-[0_0_12px_rgba(212,175,55,0.5)]" />
            <div>
              <h1 className="text-lg font-bold bg-gradient-to-r from-[#D4AF37] to-[#FFD700] bg-clip-text text-transparent leading-tight">DYNO</h1>
              <p className="text-[9px] text-gray-600 uppercase tracking-widest">Esport</p>
            </div>
          </div>
